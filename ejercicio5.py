...
# COMPLETAR - INICIO
strings_concatenados1 = "¡Mamá " "estoy concatenando " "strings!"
print(strings_concatenados1)
# COMPLETAR - FIN

assert strings_concatenados1 == "¡Mamá estoy concatenando strings!"
...
# COMPLETAR - INICIO
strings_concatenados2 = variable_01 + str(variable_02) + variable_03
print(strings_concatenados2)
# COMPLETAR - FIN

assert strings_concatenados2 == "Le debo 600 pesos a un amigo."
...
# COMPLETAR - INICIO
strings_concatenados3 = "{}{}{}{}{} Se llama {}".format(variable_01, variable_02, variable_03, variable_02, variable_04, variable_05)
print(strings_concatenados3)
# COMPLETAR - FIN

assert (
    strings_concatenados3 == "Le debo 6 pesos a un amigo hace 6 años. Se llama Ezequiel"
)
...
# COMPLETAR - INICIO
strings_concatenados4 = f'{variable_01}{variable_02}{variable_03}{variable_04}'
print(strings_concatenados4)
# COMPLETAR - FIN

assert strings_concatenados4 == "Le pagué 2 pesos que le debía a Ezequiel, me faltan $4"